...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.log("[Missions/Claim] Authorization header:", authHeader);
    const body = await req.json();
    console.log("[Missions/Claim] Body:", JSON.stringify(body));
    ...
    console.log("[Missions/Claim] Upstream response status:", status, "data:", JSON.stringify(data));
